...
class CleanOutput:
    ...
    @staticmethod
    def clean_sentence(sentence_in: str) -> str:
        """Ensure sentences don't start with spaces or punctuation

        :param sentence_in: sentence generated by model
        :return: clean sentence
        """
        # TODO - load character ingex map and filter, or sort the model/sentence generation
        if sentence_in[0] in [',', '.', '!', '?']:
